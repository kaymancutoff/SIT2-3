<%-- 
    Document   : search
    Created on : 06.06.2015, 14:23:24
    Author     : KVI
--%>
   ...
   body {
    ...
    <body>
        <div class="container" >    
            ...
            <div class="jumbotron">
            <h1>Поиск по значению</h1>
            <br>
            <form name="main" method = "POST" action="Servlet">
            <p class="lead">Введите Товар:</p>
            <input type = "text" name = "Tovar" value = ""  class="well well-sm" required="required"  pattern="^[а-яА-ЯёЁ0-9]+$"/>
            <br><button type="submit" name="command" value="search" class="btn btn-primary btn-lg">Поиск</button>
            </form>
