<%-- 
    Document   : update
    Created on : 06.06.2015, 12:20:48
    Author     : KVI
--%>
   ...
   body {
    ...
    <body>
        ...
        <form name="main" method = "POST" action="Servlet">
         <h1>Изменение записи!</h1><p></p><br><br>
            <input type="hidden" name="command" value="update" class="well well-sm" required="required" />
            ...
            <br><br><br><input type="submit" value="Обновить информацию о заказе" class="btn btn-primary btn-lg"/>
