...
<html>
   ...
   body {
    ...
    <body>
        ...
        <p class="lead">С выполненных перевозок компания получила <c:out value='${lst[0]}'/>$ прибыли.
        Ожидаемая прибыль с незавершенных перевозок равняется <c:out value='${lst[1]}'/>$.</p>
